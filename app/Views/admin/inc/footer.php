<footer class="position-static" style="margin-top:auto">
        <div class="boxfooter">
            <div class="footer-content">
                ...
                <div class="center">
                    <div class="adress">
                        <p><strong>CÔNG TY CỔ PHẦN KFruit</strong></p>
                    ...
                    <div class="adress ppc">
                        ...
                        <e><strong>Email:</strong>hotro@kfruit.com</e>
                    </div>
                    <div class="adress">
                        <img src="<?=URLROOT?>/img/ic_bct.png" alt="">
                    </div>
                </div>
    ...
    Array.from(document.querySelectorAll('.add-to-cart-btn'), element => element.addEventListener('click',function(event){
        ...
        var id_SP = this.getAttribute('data-product-id');
