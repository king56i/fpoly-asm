...
class Admin extends Controller{
    ...
    public function QuanLySPForm($id_SP=null){
        ...
        if(isset($_POST['submit'])){
            ...
            $MoTa = $_POST['MoTa']??'';
            if($id_SP!=""){
                $this->productModel->updateProduct($id_SP,$name,$HinhAnh,$id_Loai,$id_Hang,$Gia,$GiaGoc,$MoTa);
            }else{
    ...
    public function LoaiSPForm($id_Loai=null){
        if(isset($_POST['submit'])){
            ...
            if($id_Loai!=""){
                $this->productModel->updateTypeProduct($id_Loai,$TenLoai,$HinhAnh,$AnHien,$MoTa,$Urlloai);
            }else{
    ...
    public function HangForm($id_Hang=null){
        if(isset($_POST['submit'])){
            ...
            if($id_Hang!=""){
                $this->productModel->updateBrandProduct($id_Hang,$TenHang,$HinhAnh,$AnHien,$MoTa,$Urlhang);
            }else{
